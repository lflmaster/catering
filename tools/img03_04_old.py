...
class plot:
    ...
    def img1(self, user_id_list):
        ...
        # 画图 img1
        img1 = plt.figure(figsize=(20, 7), dpi=150)
        # rect可以设置子图的位置与大小 [左, 下, 宽, 高] 规定的矩形区域 （全部是0~1之间的数，表示比例）
        rect1 = [0.04, 0.05, 0.21, 0.9]
        rect2 = [0.287, 0.05, 0.21, 0.9]
        rect3 = [0.534, 0.05, 0.21, 0.9]
        rect4 = [0.78, 0.05, 0.21, 0.9]
        # x坐标值
        ...
        # lab = ["用户指标值", "指标下届值", "指标上届值"]
        lab = ["User value", "Minimum value", "Maximum value"]
        ...
        # 画图 img2
        img2 = plt.figure(figsize=(20, 7), dpi=150)
        ...
        plt.plot(data[0][1][4:-2], linewidth=1, linestyle='--')
        plt.plot(data[0][2][4:-2], linewidth=1, linestyle='--')
